...
export function HotelDetailClient({
  ...
  const hasJsonDetails = isValidV1Document(hotel.details_json);
  ...
  return (
    <main className="min-h-screen px-4 py-6">
      <div className="max-w-[720px] mx-auto">
        ...
        {(addressMain || hotel.phone) && sectionVisible("basic_info") && (
        ...
        {hasJsonDetails ? (
          <EntityDetailsRenderer details={hotel.details_json!} />
        ) : (
          <>
      ...
      {/* Hotel Core Edit Modal — relational core fields only */}
      <HotelEditModal
